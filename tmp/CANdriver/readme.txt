Information about this CAN Driver Project (Schaefer):

The demo application is within the 

Demo/AVR_AT90CAN128_WinAVR

directory.

If you want to use the AVR Studio project files you MUST
position your project-files on drive C: under the following 
directory structure:

C:\gcc\FreeRTOS\Demo\AVR_AT90CAN128_WinAVR

******************************************************************************

FreeRTOS Info:
(from the original distribution, see http://www.freertos.org)
